	  <MapOl></MapOl>	
	  <BaseLayer bind:dialog={dialogBaseLayer}></BaseLayer>
      <Drawer variant="dismissible" bind:this={myDrawer2} bind:open={myDrawer2Open}>
        
        <Content>
          <List>
		  	<Item href="javascript:void(0)" on:click={() => setActive2('Esconder')} activated={active2 === 'Star'}>
              <Graphic class="material-icons" aria-hidden="true">chevron_left</Graphic>
              <Text>Esconder</Text>
            </Item>
            <Item href="javascript:void(0)" on:click={() => dialogBaseLayer.open()} activated={active2 === 'Inbox'}>
      ...
      <AppContent class="app-content">
        <main class="main-content">
		  ...
		  <Fab class="pos" mini={true} on:click={() => myDrawer2Open = !myDrawer2Open}><Icon class="material-icons">chevron_right</Icon></Fab>
          <br />
